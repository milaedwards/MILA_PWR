...
cp_JpkgK = cfg.cp_coolant_core_J_kgK  # J/kg-K, specific heat capcity of coolant was 5545 from enghandbook.
...
@dataclass
class FBParams:
    # Feedback coefficients in pcm/Fahrenheit, from Config
